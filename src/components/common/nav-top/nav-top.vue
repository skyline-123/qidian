<template>
  <div class="nav-top">
      ...
      <span>{{titleLink.title}}</span>
      <div class="t-male-female">
        <router-link :to="titleLink.linkM"><span class="male">男生</span></router-link><router-link :to="titleLink.linkF"><span class="female">女生</span></router-link>
      </div>
